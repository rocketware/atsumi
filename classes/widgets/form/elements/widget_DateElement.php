...
class widget_DateElement extends widget_AbstractElement {
	...
	function renderElement() {
		...
		$out =	sfl("<select name='%s[day]' id='form_%s' style='width:100px;' >%s</select>", 
						$this->getName(),
						$this->getName(),
						$dayOptions

					);
		$out .=	sfl("<select name='%s[month]' id='form_%s' style='width:100px;' >%s</select>", 
						$this->getName(),
						$this->getName(),
						$monthOptions

					);
		$out .=	sfl("<select name='%s[year]' id='form_%s' style='width:100px;' >%s</select>", 
						$this->getName(),
						$this->getName(),
						$yearOptions
